...
var blobKey = /* @__PURE__ */ __name((id) => `t:${id}`, "blobKey");
var authKey = /* @__PURE__ */ __name((id) => `t:${id}:auth`, "authKey");
...
var withNow = /* @__PURE__ */ __name((extra = {}) => ({
  ...baseHeaders,
  ...extra,
...
var onRequestPut = /* @__PURE__ */ __name(async ({ params, env, request }) => {
  const id = String(params.id);
...
// ../.wrangler/tmp/pages-6dv0lM/functionsRoutes-0.4353534181407892.mjs
var routes = [
  {
    routePath: "/api/t/:id",
    mountPath: "/api/t",
...
// ../.wrangler/tmp/bundle-gVMz8f/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-gVMz8f/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9399976234031264.mjs.map
