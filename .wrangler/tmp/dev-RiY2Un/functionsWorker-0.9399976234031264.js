...
// .wrangler/tmp/pages-6dv0lM/functionsWorker-0.9399976234031264.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var MAX_BODY_BYTES = 1e6;
var blobKey = /* @__PURE__ */ __name2((id) => `t:${id}`, "blobKey");
var authKey = /* @__PURE__ */ __name2((id) => `t:${id}:auth`, "authKey");
...
var baseHeaders = { "Cache-Control": "no-store", "X-Server-Now": "" };
var withNow = /* @__PURE__ */ __name2((extra = {}) => ({
  ...baseHeaders,
  ...extra,
...
var onRequestGet = /* @__PURE__ */ __name2(async ({ params, env, request }) => {
  ...
  const { value, metadata } = await env.TOURNAMENTS.getWithMetadata(blobKey(id), "text");
...
var onRequestPut = /* @__PURE__ */ __name2(async ({ params, env, request }) => {
  const id = String(params.id);
  ...
  const { metadata } = await env.TOURNAMENTS.getWithMetadata(blobKey(id), "stream");
...
// .wrangler/tmp/bundle-J9o1av/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-J9o1av/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9399976234031264.js.map
